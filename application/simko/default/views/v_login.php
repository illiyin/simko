...
<html>
	...
	<body style="width:100%;overflow-x:hidden;" class="login-page">
        <div class="row">
            <div class="col-md-4"></div>
            <div class="col-md-4">
                <div class="login-container">
                    <div class="login-logo">
                        <img src="<?php echo base_url().AZAPP;?>assets/images/logo.png?v<?php echo time();?>">
                    </div>
                        ...
                        <div class="box-login">
                            <form method="POST" action="login/process">
                                ...
                                <div class="login-copyright">
                                    Copyright &copy; 2017 <a target="_blank" href="#">Simko</a>
                                </div>
                            </form>
                        </div>
                    </div>
